 ...
 */
	...
	$client->redirect_uri = 'http://localhost/aser/others/learning/apis/oauth-api/login_with_dropbox.php';/*.
		dirname(strtok($_SERVER['REQUEST_URI'],'?')).'/login_with_dropbox.php';*/
		
	$client->client_id = 'tk8xfdxufde9guf'; $application_line = __LINE__;
	$client->client_secret = '2nac5gng48o402e';
